/*
  ...
  Copyright 2019, The MathWorks, Inc.
	...
	MATH (THINKSPEAK) 에서 올라온 예제 파일이다. 
...
#include <WiFiEsp.h>
#include "secrets.h"  // 이건 굳이 없어도 될것 같은데 테스트 해볼 것 

char ssid[] = SECRET_SSID;   // your network SSID (name) // secrets.h 에서 읽어오는 변수 
...
SoftwareSerial Serial1(2, 3); // RX, TX  //  2 ,3 번으로 재설정 
...
unsigned long myChannelID = SECRET_CH_ID_WEATHER_STATION;
...
void loop() {
  ...
  float temperatureInF = ThingSpeak.readFloatField(myChannelID, temperatureFieldNumber);  
